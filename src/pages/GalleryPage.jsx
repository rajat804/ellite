...
const GalleryPage = () => {
  ...
  const galleryImages = [
    ...
    },
    {
      ...
      category: "dogs",
      image:
        "https://images.unsplash.com/photo-1587300003387-592e2f1b61e1?w=800",
      thumbnail:
        "https://images.unsplash.com/photo-1587300003387-592e2f1b61e1?w=400",
    ...
    },
    {
      ...
      thumbnail:
        "https://images.unsplash.com/photo-1544568100-847a5145851d?w=400",
    ...
    },
    {
      ...
      thumbnail:
        "https://images.unsplash.com/photo-1577023311546-cdc07a8454d9?w=400",
      title: "Grey Cat",
    ...
    >
      <section className="relative bg-gradient-to-r from-[#007B7F] to-[#005C5F] h-screen max-h-[700px] min-h-[550px] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div
            className={`max-w-3xl mx-auto text-center text-white transition-all duration-1000 ${
              isVisible
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-md px-5 py-2 rounded-full mb-6">
              <FaCamera className="text-[#FFD1B3]" />
            ...
            {/* Description */}
            <p className="text-lg md:text-xl text-[#FFD1B3] leading-relaxed">
        ...
        <div className="absolute bottom-0 left-0 w-full">
          ...
          >
            <path
              fill="#FFF9F0"
              d="M0,96L48,112C96,128,192,160,288,160C384,160,480,128,576,122.7C672,117,768,139,864,154.7C960,171,1056,181,1152,165.3C1248,149,1344,107,1392,85.3L1440,64L1440,320L0,320Z"
            ></path>
          </svg>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 md:px-8 -mt-12 relative z-20">
        ...
        >
          {[
            ...
            <div
              key={idx}
              className={`bg-gradient-to-br ${stat.bg} rounded-xl p-4 text-center shadow-lg hover:shadow-xl transition-all hover:-translate-y-2 cursor-pointer group`}
            >
              <div
              ...
              <div className="text-xl md:text-2xl font-bold text-[#2C3E50]">
                {stat.value}
              </div>
      ...
      <div className="container mx-auto px-4 md:px-8 pt-12 pb-8">
        <div
          className={`flex flex-wrap justify-center gap-3 mb-10 transition-all duration-700 delay-300 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
            ...
            <button
              ...
              className={`flex items-center gap-2 px-6 py-2.5 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 ${
                selectedCategory === category.id
                  ? "bg-[#007B7F] text-white shadow-lg"
            ...
            >
              <div className="relative bg-white rounded-2xl overflow-hidden shadow-lg group-hover:shadow-2xl transition-all duration-500 group-hover:-translate-y-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-3 text-white/70 text-xs">
                        <span className="flex items-center gap-1">
                          <FaHeart className="text-[#FFD1B3]" /> {image.likes}
                        </span>
                        <span className="flex items-center gap-1">
                ...
                <div className="p-4 bg-white">
                  <h3 className="font-bold text-[#2C3E50] mb-1 group-hover:text-[#007B7F] transition-colors">
                    {image.title}
                  </h3>
      ...
      <section className="py-16 bg-gradient-to-r from-[#007B7F]/5 to-[#FFD1B3]/20">
        <div className="container mx-auto px-4 md:px-8 text-center">
          ...
          >
            <div className="w-20 h-20 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center mx-auto mb-5 shadow-lg">
            ...
            <p className="text-gray-600 mb-6">
              Get daily updates and cute moments on Instagram
            </p>
            <button className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-8 py-3 rounded-full font-semibold hover:shadow-xl transition-all hover:scale-105 inline-flex items-center gap-2">
              <FaInstagram /> @happypettings
            </button>
          </div>
        </div>
      </section>
      ...
      {lightboxOpen && selectedImage && (
        ...
        >
          ...
          <button
            onClick={closeLightbox}
            className="absolute top-4 right-4 text-white bg-white/10 hover:bg-white/20 p-3 rounded-full transition-all z-10 backdrop-blur-sm"
          >
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <div className="flex items-center gap-4 text-white/60 text-sm">
                    <span className="flex items-center gap-1">
                      <FaHeart /> {selectedImage.likes} likes
                    </span>
                    <span className="flex items-center gap-1">
                      <FaComment /> {selectedImage.comments} comments
                    </span>
                    <span className="flex items-center gap-1">
                      <FaEye /> {selectedImage.views} views
                    </span>
