...
const PrivacyPolicyPage = () => {
  ...
  const sections = [
    {
      ...
      icon: <MdPrivacyTip />,
      content: [
        "At Happy Pettings, we are committed to protecting your privacy and the security of your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our services.",
    ...
    },
    {
      ...
      content: [
        ...
        "• This policy applies only to information collected by Happy Pettings."
      ]
    },
    {
      id: 12,
  ...
  const dataCollectionPoints = [
    { icon: <FaFileAlt />, text: "Booking Forms", color: "#007B7F" },
    { icon: <FaMobile />, text: "Mobile App", color: "#E67E22" },
    { icon: <FaGlobe />, text: "Website", color: "#FF7A2F" },
    { icon: <FaPhoneAlt />, text: "Phone Calls", color: "#6B4E71" },
    { icon: <FaEnvelope />, text: "Emails", color: "#007B7F" },
    { icon: <FaCreditCard />, text: "Payments", color: "#E67E22" }
  ];

  return (
    <div id="privacy-page" className="min-h-screen bg-gradient-to-b from-white to-[#FFF9F0]">
      {/* Hero Section */}
      ...
      <div className="container mx-auto px-4 md:px-8 -mt-12 relative z-20">
        <div className={`grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 transition-all duration-700 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          {dataCollectionPoints.map((point, idx) => (
            <div key={idx} className="bg-white rounded-xl p-3 text-center shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
              <div className="w-10 h-10 mx-auto bg-gradient-to-br from-[#007B7F]/10 to-[#FFD1B3]/20 rounded-xl flex items-center justify-center mb-2" style={{ color: point.color }}>
                <span className="text-lg">{point.icon}</span>
              </div>
              <p className="text-xs font-semibold text-[#2C3E50]">{point.text}</p>
            </div>
          ))}
        </div>
      </div>
          ...
          <div className={`lg:col-span-1 transition-all duration-700 delay-300 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            <div className="sticky top-24 bg-white rounded-2xl shadow-lg p-5">
              <h3 className="text-lg font-bold text-[#2C3E50] mb-4 pb-2 border-b border-gray-200 flex items-center gap-2">
                <MdPrivacyTip className="text-[#007B7F]" /> Contents
              </h3>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8">
              ...
              <div className="mb-8 pb-6 border-b border-gray-200">
                <p className="text-gray-600 mb-3">
                  At Happy Pettings, we are committed to protecting your privacy and ensuring the security of your personal information. 
              ...
              <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-xl">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-green-800">GDPR Compliant</h3>
                    <p className="text-sm text-green-700">We comply with global data protection regulations to safeguard your privacy.</p>
                  </div>
                </div>
              </div>
                ...
                <div className="mt-8 p-5 bg-gray-50 rounded-xl border border-gray-200">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-start gap-3">
                      <FaCookie className="text-[#007B7F] text-2xl mt-1" />
                      <div>
                        <h4 className="font-bold text-[#2C3E50] mb-1">Cookie Preferences</h4>
                    ...
                    <button 
                      ...
                      className="bg-[#007B7F] text-white px-4 py-2 rounded-lg text-sm hover:bg-[#007B7F]/80 transition-all whitespace-nowrap"
                    >
                      Accept All
                    </button>
                  </div>
              ...
              <div className="mt-10 p-6 bg-gradient-to-r from-[#007B7F]/5 to-[#FFD1B3]/20 rounded-2xl">
                <h3 className="text-lg font-bold text-[#2C3E50] mb-4 flex items-center gap-2">
                  <FaEnvelope className="text-[#007B7F]" /> Privacy Questions?
                </h3>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-600">privacy@happypettings.com</span>
                  </div>
                  <div className="flex items-center gap-3">
              ...
              <div className="mt-6 flex flex-wrap gap-3 justify-center">
                <button className="bg-[#007B7F] text-white px-5 py-2 rounded-lg text-sm hover:bg-[#007B7F]/80 transition-all">
                  Request Data Access
                </button>
                <button className="border-2 border-[#007B7F] text-[#007B7F] px-5 py-2 rounded-lg text-sm hover:bg-[#007B7F] hover:text-white transition-all">
                  Request Data Deletion
                </button>
                <button className="border-2 border-gray-300 text-gray-600 px-5 py-2 rounded-lg text-sm hover:border-[#007B7F] hover:text-[#007B7F] transition-all">
                  Update Preferences
                </button>
              </div>
      ...
      <section className="py-8 bg-[#2C3E50] text-white text-center">
        <div className="container mx-auto px-4">
          <p className="text-sm opacity-80">
            © 2024 Happy Pettings. All rights reserved. | Privacy Policy | Last Updated: {lastUpdated}
          </p>
        </div>
      </section>
